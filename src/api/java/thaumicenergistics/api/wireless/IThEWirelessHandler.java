...
//    @Override
    // String getEncryptionKey(ItemStack is);

//    void openWirelessTerminalGui(EntityPlayer player);

//    @Deprecated
//    void openWirelessTerminalGui(EntityPlayer player, IThEWirelessHandler terminalInterface);
}
